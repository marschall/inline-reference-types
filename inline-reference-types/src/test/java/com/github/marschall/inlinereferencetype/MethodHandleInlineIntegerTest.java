...
public class MethodHandleInlineIntegerTest {
  ...
  static final class SimpleTO {
    ...
    static final MethodHandleInlineInteger TRANSACTION_CLASS_INTEGER; 
    ...
    static {
      ...
      TRANSACTION_CLASS_INTEGER = MethodHandleInlineInteger.create(lookup, SimpleTO.class, "transactionClass", "transactionClassIsNull");
    }
